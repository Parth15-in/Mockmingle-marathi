              ...
              >
                ...
                >
                  ...
                  <div className="p-6 border-t border-white/10 bg-slate-950 shrink-0 flex justify-end gap-3">
                    ...
                    <button
                      onClick={() => router.push(`/suggestion?subject=${encodeURIComponent(selectedReport.subject || selectedReport.role)}`)}
                      className="px-5 py-3 bg-red-600/20 text-red-400 border border-red-500/30 rounded-xl font-bold transition-all flex items-center gap-2 hover:bg-red-600/30"
                    >
                      🎥 व्हिडिओ सूचना
                    </button>
                    <button
